...
Question = (function(_super) {
  ...
  Question.prototype.loadFromDesigner = function(domNode) {
    var attribute, property, question, questionArray, questionProperties, result, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
    ...
    if (result.length === 1) {
      ...
      _ref = ["label", "type", "repeatable", "required", "validation", "enabled"];
      ...
      questionArray = [];
      _ref1 = result.questions();
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        question = _ref1[_j];
        attribute = {};
        _ref2 = ["id", "_id", "label", "type", "repeatable", "required", "validation", "safeLabel", "radio-options", "select-options"];
...
Question.fromDomNode = function(domNode) {
  return _(domNode).chain().map((function(_this) {
    return function(question) {
      var attribute, enabled, id, property, propertyValue, result, _i, _len, _ref;
      question = $(question);
      id = question.attr("id");
