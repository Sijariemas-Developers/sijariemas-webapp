...
Sync = (function(_super) {
  ...
  Sync.prototype.replicateFromServer = function(options, completeMsgId) {
    var filter, opts;
    if (!options) {
      options = {};
    }
    ...
    opts = {
      ...
      complete: function(result) {
        ...
        if (typeof result !== 'undefined' && result.ok) {
          ...
          Coconut.debug("replicateFromServer - onComplete: Replication message: " + jsonResult);
          if (typeof completeMsgId !== 'undefined' && completeMsgId !== null) {
            $(completeMsgId).append("replicateFromServer complete; potential problem:" + jsonResult + '<br/>');
            $(completeMsgId).append("<a data-role=\"button\" id=\"reloadApp\" class=\"btn btn-primary btn-lg\">Reload app</a><br/>");
          }
          return {
            error: function(result) {
  ...
  Sync.prototype.replicateForms = function(options, completeMsgId) {
    var opts;
    ...
    opts = {
      ...
      complete: function(result) {
        ...
        if (typeof result !== 'undefined' && result.ok) {
          ...
          jsonResult = JSON.stringify(result);
          Coconut.debug("replicateForms - onComplete: Replication message: " + jsonResult);
          if (typeof completeMsgId !== 'undefined' && completeMsgId !== null) {
            return $(completeMsgId).append("replicateForms complete; potential problem:" + jsonResult + '<br/>');
          }
        }
      },
      error: function(result) {
  ...
  Sync.prototype.replicateToServer = function(options, completeMsgId) {
    var filter, opts;
    if (!options) {
      options = {};
    }
    ...
    opts = {
      ...
      complete: function(result) {
        ...
        if (typeof result !== 'undefined' && result.ok) {
          ...
          jsonResult = JSON.stringify(result);
          Coconut.debug("replicateToServer - onComplete: Replication message: " + jsonResult);
          if (typeof completeMsgId !== 'undefined' && completeMsgId !== null) {
            return $(completeMsgId).append("replicateToServer complete; potential problem:" + jsonResult + '<br/>');
          }
        }
      },
      error: function(result) {
